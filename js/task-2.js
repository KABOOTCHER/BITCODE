...
const tasks = {
	...
	array: {
		title: "Массив",
		description: "Тебе нужно создать массив из нескольких чисел. Напиши функцию, которая будет принимать этот массив и возвращать сумму всех его элементов. Используй цикл for или метод массива reduce для сложения элементов."
	},
	objects: {
		title: "Объекты",
	...
	cycle: {
		title: "Циклы",
		description: "Напиши функцию, которая будет принимать массив чисел и возвращать массив, в котором каждый элемент умножен на 2. Используй цикл for для обработки каждого элемента массива и умножения его на 2."
	},
	strings: {
		title: "Строки",
		description: "Напиши функцию, которая будет принимать строку и возвращать её в верхнем регистре. Используй метод toUpperCase() для преобразования строки в верхний регистр. Протестируй свою функцию с разными строками, чтобы убедиться, что она работает правильно."
	},
	events: {
